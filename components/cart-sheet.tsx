...
//                         <Image
//                           src={mediaUrlGenerator(item.selected_variant.thumbnail?.url)}
//                           alt={item.title}
//                           fill
...
//                         <p className="text-sm font-semibold text-gray-900">₹ {item.selected_variant.price}</p>
//                       </div>
                  ...
                  {items.map((item) => (
                    <div key={item.id} className="flex items-center space-x-4 p-2 border rounded-lg">
                      <div className="relative w-14 h-14 flex-shrink-0">
                        <Image
                          src={mediaUrlGenerator(
                            item.selected_variant?.thumbnail?.url ||
                            item.thumbnail?.url ||
                      ...
                      <div className="flex items-center space-x-2">
                        <Button
                          ...
                          size="icon"
                          className="h-8 w-8"
                          onClick={() => handleQuantityChange(item.id, item.cart_quantity - 1)}
                        >
                          <Minus className="h-3 w-3" />
                        </Button>
                        <span className="w-8 text-center text-sm font-medium">{item.cart_quantity}</span>
